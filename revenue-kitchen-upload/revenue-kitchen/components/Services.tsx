export default function Services() {
  ...
  return (
    <section id="services" className="rk-section" style={{padding:"100px 60px",background:"#fff"}}>
      ...
      <p style={{fontSize:"15px",color:"#5a7070",lineHeight:1.8,maxWidth:"520px",marginBottom:"64px"}}>Most agencies guess. I know. I run the restaurant. Every service is built around one thing — measurable ROI. If it doesn&apos;t make you money, we don&apos;t do it.</p>
