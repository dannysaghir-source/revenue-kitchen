...
export default function Footer() {
  return (
    <footer style={{background:"#f4f7f7",borderTop:"1px solid #e0eaea",padding:"36px 60px",display:"flex",justifyContent:"space-between",alignItems:"center",gap:"16px",flexWrap:"wrap"}}>
