...
export default function Nav() {
  ...
  return (
    <>
      ...
      {menuOpen&&(
        <div style={{position:"fixed",top:"88px",left:0,right:0,background:"#fff",borderBottom:"1px solid #e0eaea",zIndex:99,padding:"24px 20px",display:"flex",flexDirection:"column",gap:"20px"}}>
