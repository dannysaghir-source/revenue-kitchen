export default function Who() {
  return (
    <section id="who" className="rk-section" style={{padding:"100px 60px",background:"#f8f8f8"}}>
      ...
      <div className="rk-grid-3" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"24px",marginBottom:"24px"}}>
        {[
      ...
      <div className="rk-not-for" style={{background:"#1c1c1e",borderRadius:"16px",padding:"40px 48px",display:"grid",gridTemplateColumns:"auto 1fr",gap:"32px",alignItems:"center"}}>
