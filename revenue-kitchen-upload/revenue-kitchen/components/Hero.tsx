...
export default function Hero() {
  ...
  return (
    <section id="hero" style={{display:"flex",flexDirection:"column",padding:"20px 60px 80px",marginTop:"88px",position:"relative",overflow:"hidden",background:"linear-gradient(135deg,#0d1f1f 0%,#0e3030 60%,rgba(14,158,142,0.15) 100%)"}}>
      ...
      <h1 style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:"clamp(64px,10vw,148px)",lineHeight:0.9,maxWidth:"900px",margin:"0 0 32px 0",color:"#fff"}}>
      ...
      <div style={{display:"flex",gap:"48px",flexWrap:"wrap",paddingTop:"36px",borderTop:"1px solid rgba(255,255,255,0.12)"}}>
